...
struct EmployeeDetailView: View {
    ...
    var body: some View {
        TabView(selection: $selectedTab) {
            ...
            // Add a section for Unpaid Salary in the EmployeeDetailView
            Section(header: Text("Salary Management")) {
                NavigationLink(destination: UnpaidSalaryView()) {
                    HStack {
                        ...
                        VStack(alignment: .leading) {
                            Text("Unpaid Salary")
                                .font(.headline)
                            Text("Track and manage unpaid salary periods")
                                .font(.caption)
                                .foregroundColor(.secondary)
                        }
                    }
